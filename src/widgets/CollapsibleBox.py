...
class CollapsibleBox(QWidget):
    def __init__(self, iconName : str, item : Item, config, parent=None):
        ...
        self.header = QWidget()
        self.header.setToolTip('Open this collapsible box.')
        ...
        self.runButton.setToolTip('Runs this test case.')
        ...
        self.clearButton.setToolTip('Clears the results of this test case.')
        ...
        self.inputCmdText.setToolTip("The code that runs for this test case.")
        
        outputCommandLabel = QLabel("Output:")
        self.outputCmdIndexCombo = QComboBox()
        self.outputCmdIndexCombo.setToolTip("The output generated by this test case.")
        ...
        self.checkModeCombo.setToolTip('Select which type of verification will be used for this test case.')
        ...
        self.operatorCombo.setToolTip('Select the operation for the validation operation.')
        ...
        self.operatorValueEdit.setToolTip('The value used for the validation operation.')
    ...
    def toggleContent(self, event):
        ...
        if self.content.isVisible():
            ...
            # Open the window.
            self.header.setToolTip('Close this collapsible box.')
